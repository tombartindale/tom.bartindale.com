...
(function ($) {
  skel.init({
    reset: "full",
    breakpoints: {
      global: { range: "*", href: "/wp-content/themes/tombv1/css/style.css" },
      desktop: {
        range: "737-",
        href: "/wp-content/themes/tombv1/css/style-desktop.css",
        containers: 1200,
        grid: { gutters: 25 },
      },
      "1000px": {
        range: "737-1200",
        href: "/wp-content/themes/tombv1/css/style-1000px.css",
        containers: 960,
        grid: { gutters: 25 },
        viewport: { width: 1080 },
      },
      mobile: {
        range: "-736",
        href: "/wp-content/themes/tombv1/css/style-mobile.css",
        containers: "100%",
